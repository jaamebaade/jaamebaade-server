...
class JwtService {
    ...
    fun generateToken(userDetails: UserDetails, jwtExpiration: Date): String {
        return generateToken(HashMap(), userDetails, jwtExpiration.time - System.currentTimeMillis())
    }
